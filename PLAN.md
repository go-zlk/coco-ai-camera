...
目标：2 周内从「开箱」到「一份带真实数据的 README + 一条 30 秒 demo 视频 + 一套可复现的验证记录」。
...
| D13–14 | 填 README 真实数字、画架构图、初始化 Git 并推送远端、整理复现说明 | 可复现的阶段版本 |
...
- 文档能够清楚说明 H2D / compute / D2H 和端到端 FPS 的区别，并给出对应测量方法。
